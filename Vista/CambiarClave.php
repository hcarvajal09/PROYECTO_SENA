...
<body class="hold-transition sidebar-mini">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    if (isset($_POST) && !empty($_POST)) {
                                        $objeto->setcorreo($_SESSION['usuarioSesion']);
                                        $objeto->setclave(md5($_POST['clavenueva']));
                                        ...
                                        if ($resultado == "correcto") {
                                            ...
                                            $mensaje = "Contraseña NO Cambiada".$resultado;
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-5">
                                                ...
                                                <input class="form-control" type="password" placeholder="Digite la contraseña" name="clavenueva" id="clavenueva">
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-5">
                                                ...
                                                <input class="form-control" type="password" placeholder="Digite la contraseña" name="confirmarclave" id="confirmarclave">
                                            </div>
                                        </div>
    ...
    <!-- OPTIONAL SCRIPTS -->
    <script src="dist/js/validar-clave.js"></script>
