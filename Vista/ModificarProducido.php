...
<head>
	...
	<title>Modificar Producido</title>
...
<body class="hold-transition sidebar-mini">
						...
						<div class="col-12">
							<div class="card">
								<div class="card-header bg-secondary">
									<CENTER><h2>MODIFICAR PRODUCIDO</h2></CENTER>
								</div>
								<div class="card-body">
									<?php
									if(isset($_POST) && !empty($_POST)){
										...
										$objeto->setproduccion(($_POST['produccion']));

										$resultado = $objeto->ModificarProducido();

										if ($resultado == "correcto") {
											$mensaje = "El producido fue modificado correctamente";
											?>
											...
											$mensaje = "El producido no fue modificado. " .$resultado;
											?>
									...
									$datos = $objeto->ConsultarDatosProducido($codigo);
									...
									<form method="post" onsubmit="return validar();">
										...
										<div class="row justify-content-center">
											<div class="col-5">
												...
												<input class="formulario__input form-control"  type="text" readonly="true" name="codigo" id="codigo" value="<?php echo $datos->produ_id;?>" onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>

											<!-- Grupo: Cantidad -->
											<div class="col-5">
												<label for="cantidad">Cantidad Producida</label>
												<input class="formulario__input form-control" type="text" name="cantidad" id="cantidad" value="<?php echo $datos->produ_cantidad_producida;?>" onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
										</div><br>
										...
										<div class="row justify-content-center">
											...
											<div class="col-5">
												...
												<input class="formulario__input form-control" type="text" name="produccion" id="produccion" value="<?php echo $datos->prod_id;?>" onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
										</div><br>
									</div>

									<div class="row justify-content-center">
										<a type="button" href="ConsultarProducido.php" class="btn btn-outline-secondary mx-2">Cancelar</a>
	...
	<!-- OPTIONAL SCRIPTS -->
	<script src="dist/js/validacion-producido.js"></script>
