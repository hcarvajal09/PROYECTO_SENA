              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  if (isset($_POST) && !empty($_POST)) {
                    ...
                    $resultado = $objeto->ModificarCliente();
                    ...
                    if ($resultado == "correcto") {
                      ...
                      $mensaje = "El cliente no fue modificado. " .$resultado;
                      ?>
                  ...
                  $datos = $objeto->ConsultarDatosCliente($codigo);
                  ...
                  <form method="post" onsubmit="return validar();">
                    ...
                    <div class="row justify-content-center">
                      <div class="col-5">
                        ...
                        <input class="formulario__input form-control"  type="text" placeholder="Digite el nombre"  name="nombre" id="nombre" value="<?php echo $datos->clie_nombres; ?>"  onkeyup="javascript:this.value=this.value.toUpperCase();">
                      </div>

                      <!-- Grupo: Apellido -->
                      <div class="col-5">
                        <label for="apellido">Apellido</label>
                        <input class="formulario__input form-control" type="text" placeholder="Digite el apellido" name="apellido" required  id="apellido" value="<?php echo $datos->clie_apellidos; ?>"  onkeyup="javascript:this.value=this.value.toUpperCase();">
                      </div>
                    </div><br>
                    ...
                    <div class="row justify-content-center">
                      <div class="col-5">
                        ...
                        <input class="formulario__input form-control" type="text" placeholder="Digite el documento"  name="documento" id="documento" value="<?php echo $datos->clie_documento; ?>"  onkeyup="javascript:this.value=this.value.toUpperCase();">
                      </div>

                      <!-- Grupo: Telefono -->
                      <div class="col-5">
                        <label for="telefono">Teléfono </label>
                        <input class="formulario__input form-control" type="text" placeholder="Digite el teléfono " name="telefono" id="telefono" value="<?php echo $datos->clie_telefono; ?>"  onkeyup="javascript:this.value=this.value.toUpperCase();">
                      </div>
                    </div><br>
                    ...
                    <div class="row justify-content-center">
                      <div class="col-5">
                        ...
                        <input class="formulario__input form-control" type="text" placeholder="Digite la dirección"  name="direccion" id="direccion" value="<?php echo $datos->clie_direccion; ?>"  onkeyup="javascript:this.value=this.value.toUpperCase();">
                      </div>

                      <!-- Grupo: Estado -->
                      <div class="col-5">
                        <label for="estado" class="formulario__label">Estado</label>
                        <select name="estado" id="estado" class="form-control" value="<?php echo $datos->clie_estado; ?>"  onkeyup="javascript:this.value=this.value.toUpperCase();">
                    ...
                    <div class="row justify-content-center">
                      <div class="col-5">
                        ...
                        <input class="formulario__input form-control"  readonly="true" type="text" name="codigo" id="codigo" value="<?php echo $datos->clie_id; ?>"  onkeyup="javascript:this.value=this.value.toUpperCase();">
                      </div>
                  ...
                  <div class="row justify-content-center">
                    <a type="button" href="ConsultarClientes.php" class="btn btn-outline-secondary mx-2">Cancelar</a>
