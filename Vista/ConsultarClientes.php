    ...
    <div class="content-wrapper"><br>
      ...
      <div class="content">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form method="post">
                          ...
                          <div class="row justify-content-center">
                            <div class="col-5">
                              ...
                              <input class="formulario__input form-control" type="text" placeholder="Digite la dirección" name="direccion" id="direccion" onkeyup="javascript:this.value=this.value.toUpperCase();">
                            </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <button type="submit" onclick="return validar();" name="submit" class="btn btn-primary">Guardar Datos</button>
                        </form>
                      </div><br><br>
                  ...
                  <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                      <div class="modal-header bg-dark">
                        <h4 class="modal-title">Clientes Inactivos</h4>
                        <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
                          ...
                          <div class="card-body">
                            <div class="table-responsive">
                              <table id="" class="table table-bordered table-striped">
                                ...
                                <?php
                                $listado  = $objeto->ConsultarClientesInactivos();
                                ...
                                <tbody>
                                  ...
                                  while ($fila = mysqli_fetch_object($listado)) {
                                    $codigo = $fila->clie_id;
                                    $nombres = $fila->clie_nombres;
                                    $apellidos = $fila->clie_apellidos;
                                    $documento = $fila->clie_documento;
                                    $telefono = $fila->clie_telefono;
                                    $direccion = $fila->clie_direccion;
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <center><a href="ActivarCliente.php?id=<?php echo $codigo; ?>" onclick="return Activar()" class="btn btn-success" type="button">Activar</a></center>
                                      </td>
                                      <?php
                                    }
                                    ?>
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      ...
                      if (isset($_POST) && !empty($_POST)) {
                        ...
                        $resultado = $objeto->RegistrarCliente();
                      ...
                      <table id="example" class="table table-bordered table-striped">
                        ...
                        <?php
                        $listado  = $objeto->ConsultarClientesActivos();
                        ...
                        <tbody>
                          ...
                          while ($fila = mysqli_fetch_object($listado)) {
                            ...
                            <tr>
                              ...
                              <td><?php echo $telefono; ?></td>
                              <td><?php echo $direccion; ?></td>
                              <td><a href="ModificarCliente.php?id=<?php echo $codigo; ?>" class="btn btn-warning" type="button"><i class="fa fa-edit"></i></a>
                                <a onclick="return Eliminar()" style="display: <?php echo $Ocultar; ?>;" href="EliminarCliente.php?id=<?php echo $codigo; ?>" class="btn btn-danger" type="button"><i class="fa fa-trash"></i></a></td>
                                <?php
                              }
                              ?>
                            </tbody>
        ...
        <script type="text/javascript">
          function Eliminar() {
            var respuesta = confirm("¿Estas seguro que desea eliminar este cliente?");
        ...
        <script type="text/javascript">
          function Activar() {
            var respuesta = confirm("¿Estas seguro que desea activar este cliente?");
