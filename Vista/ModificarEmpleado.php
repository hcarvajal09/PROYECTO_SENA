 					...
 					<div class="row">
 						<div class="col-12">
 							<div class="card">
 								...
 								<div class="card-body">
 									<?php
										if (isset($_POST) && !empty($_POST)) {
											...
											$resultado = $objeto->ModificarEmpleado();
											...
											if ($resultado == "correcto") {
												...
												$mensaje = "El empleado no fue modificado. " .$resultado;
												?>
										...
										$datos = $objeto->ConsultarDatosEmpleado($codigo);
 									...
 									<form method="post" onsubmit="return validar();">
 										...
 										<div class="row justify-content-center">
 											<div class="col-5">
 												...
 												<input class="formulario__input form-control" type="text" placeholder="Digite el nombre" name="nombre" id="nombre" value="<?php echo $datos->emp_nombres; ?>" onkeyup="javascript:this.value=this.value.toUpperCase();">
 											</div>

 											<!-- Grupo: Apellido -->
 											<div class="col-5">
 												<label for="apellido">Apellido</label>
 												<input class="formulario__input form-control" type="text" placeholder="Digite el apellido" name="apellido" id="apellido" value="<?php echo $datos->emp_apellidos; ?>" onkeyup="javascript:this.value=this.value.toUpperCase();">
 											</div>
 										</div><br>
 										...
 										<div class="row justify-content-center">
 											<div class="col-5">
 												...
 												<input class="formulario__input form-control" type="text" placeholder="Digite el documento" name="documento" id="documento" value="<?php echo $datos->emp_documento; ?>" onkeyup="javascript:this.value=this.value.toUpperCase();">
 											</div>

 											<!-- Grupo: Telefono -->
 											<div class="col-5">
 												<label for="telefono">Teléfono</label>
 												<input class="formulario__input form-control" type="text" placeholder="Digite el teléfono" name="telefono" id="telefono" value="<?php echo $datos->emp_telefono; ?>" onkeyup="javascript:this.value=this.value.toUpperCase();">
 											</div>
 										</div><br>
 										...
 										<div class="row justify-content-center">
 											...
 											<div class="col-5">
 												...
 												<select name="estado" id="estado" class="form-control" value="<?php echo $datos->emp_estado; ?>" onkeyup="javascript:this.value=this.value.toUpperCase();">
 										...
 										<div class="row justify-content-center">
 											<div class="col-5">
 												...
 												<input class="formulario__input form-control" type="text" readonly="true" name="codigo" id="codigo" value="<?php echo $datos->emp_id; ?>" onkeyup="javascript:this.value=this.value.toUpperCase();">
 											</div>
 								...
 								<div class="row justify-content-center">
 									<a type="button" href="ConsultarEmpleados.php" class="btn btn-outline-secondary mx-2">Cancelar</a>
