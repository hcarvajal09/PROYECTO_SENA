...
<body class="hold-transition sidebar-mini">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <button type="button" class="btn btn-primary mx-2" data-toggle="modal" data-target="#modal-lg">
                          ...
                          <div class="card-body">
                            <div class="table-responsive">
                              <table id="" class="table table-bordered table-striped">
                                ...
                                <?php
                                $listado  = $objeto->ConsultarProveedoresInactivos();
                                ...
                                <tbody>
                                  ...
                                  while ($fila = mysqli_fetch_object($listado)) {
                                    $codigo = $fila->prov_id;
                                    $nombres = $fila->prov_nombres;
                                    $apellidos = $fila->prov_apellidos;
                                    $documento = $fila->prov_documento;
                                    $telefono = $fila->prov_telefono;
                                  ...
                                  ?>
                                    <tr>
                                      ...
                                      <td>
                                        <center><a href="ActivarProveedor.php?id=<?php echo $codigo; ?>" onclick="return Activar()" class="btn btn-success" type="button">Activar</a></center>
                                      </td>
                                    <?php
                                  }
                                    ?>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    ...
                    if (isset($_POST) && !empty($_POST)) {
                      ...
                      $resultado = $objeto->RegistrarProveedor();

                      if ($resultado == "correcto") {
                        $mensaje = "El proveedor fue registrado correctamente";
                        ?>
                      ...
                      <?php
                        ...
                        $mensaje = "El proveedor no fue registrado. " .$resultado;
                        ?>
                    ...
                    <table id="example" class="table table-bordered table-striped">
                      ...
                      <?php
                      $listado  = $objeto->ConsultarProveedoresActivos();
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td><center><a href="ModificarProveedor.php?id=<?php echo $codigo; ?>" class="btn btn-warning" type="button"><i class="fa fa-edit"></i></a>
                              <a onclick="return Eliminar()" href="EliminarProveedor.php?id=<?php echo $codigo; ?>" class="btn btn-danger" type="button"><i class="fa fa-trash"></i></a></center></td>
                          <?php
                        }
                          ?>
                      </tbody>
  ...
  <script type="text/javascript">
    function Eliminar() {
      var respuesta = confirm("¿Estas seguro que desea eliminar este proveedor?");
