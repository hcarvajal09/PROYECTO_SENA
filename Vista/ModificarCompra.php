            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header bg-secondary">
                  <CENTER><h2>MODIFICAR COMPRA</h2></CENTER>
                </div>
                <div class="card-body">
                  <?php
                  if (isset($_POST) && !empty($_POST)) {
                    ...
                    $objeto->setempleado(1);
                    $objeto->setproveedor(($_POST['proveedor']));

                    $resultado = $objeto->ModificarCompras();

                    if ($resultado == "correcto") {
                      $mensaje = "La compra fue modificada correctamente";
                      ?>
                      ...
                      $mensaje = "La compra no fue modificada. " .$resultado;
                      ?>
                  ...
                  $datos = $objeto->ConsultarDatosCompra($codigo);
                  ...
                  <form method="post" onsubmit="return validar();">
                    ...
                    <div class="row justify-content-center">
                      <div class="col-5">
                        ...
                        <input class="formulario__input form-control" type="text" placeholder="Digite el nombre"  name="codigo" id="codigo" readonly="true" value="<?php echo $datos->comp_id; ?>"  onkeyup="javascript:this.value=this.value.toUpperCase();">
                      </div>

                      <!-- Grupo: Nombre -->
                      <div class="col-5">
                        <label for="nombre">Nombre Materia Prima</label>
                        <input class="formulario__input form-control" type="text" placeholder="Digite el nombre"  name="nombre" id="nombre" required value="<?php echo $datos->comp_nombre_materia_prima; ?>" onkeyup="javascript:this.value=this.value.toUpperCase();">
                      </div>
                    </div><br>
                    ...
                    <div class="row justify-content-center">
                      <div class="col-5">
                        ...
                        <input class="formulario__input form-control" type="text" placeholder="Digite la cantidad" name="cantidad" id="cantidad" required value="<?php echo $datos->comp_cantidad_materia_prima; ?>" onkeyup="javascript:this.value=this.value.toUpperCase();">
                      </div>
                      ...
                      <div class="col-5">
                        ...
                        <input class="formulario__input form-control" type="text" placeholder="Digite el precio"  name="precio" id="precio" required value="<?php echo $datos->comp_precio; ?>" onkeyup="javascript:this.value=this.value.toUpperCase();">
                      </div>
                    </div><br>
                    ...
                    <div class="row justify-content-center">
                      <div class="col-5">
                        ...
                        <select class="formulario__input form-control" name="proveedor" id="proveedor" class="form-control" value="<?php echo $datos->prov_nombres; ?>" onkeyup="javascript:this.value=this.value.toUpperCase();">
                          <?php
                 ...
                 <div class="row justify-content-center">
                  <a type="button" href="ConsultarCompras.php" class="btn btn-outline-secondary mx-2">Cancelar</a>
