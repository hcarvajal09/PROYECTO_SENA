                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      <div class="modal-header bg-dark text-white">
                        <h4 class="modal-title">Nueva Materia Prima</h4>
                          ...
                          <div class="row justify-content-center">
                            ...
                            <div class="col-5">
                              <label for="cantidad">Cantidad</label>
                                <input class="formulario__input form-control" type="text" placeholder="Digite la cantidad existente" name="cantidad" id="cantidad" onkeyup="javascript:this.value=this.value.toUpperCase();">
                            </div>
                          </div><br />
                        </div>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    ...
                    if (isset($_POST) && !empty($_POST)) {
                        ...
                        $resultado = $objeto->RegistrarMateriaPrima();

                        if ($resultado == "correcto") {
                          $mensaje = "La materia prima fue registrada correctamente";
                          ?>
                          ...
                          $mensaje = "La materia prima no fue registrada. " .$resultado;
                          ?>
                      ...
                      <tbody>
                        ...
                        while ($fila = mysqli_fetch_object($listado)) {
                          ...
                          <tr>
                            ...
                            <td><a href="ModificarMateriaPrima.php?id=<?php echo $codigo; ?>" class="btn btn-warning" type="button"><i class="fa fa-edit"></i></a>
                              <a onclick="return Eliminar()" style="display: <?php echo $Ocultar; ?>;" href="EliminarMateriaPrima.php?id=<?php echo $codigo; ?>" class="btn btn-danger" type="button"><i class="fa fa-trash"></i></a></td>
                          <?php
                        }
                          ?>
                          </tbody>
