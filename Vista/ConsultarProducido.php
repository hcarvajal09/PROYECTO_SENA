...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    ...
                    <table id="example" class="table table-bordered table-striped">
                      ...
                      <?php
                      $listado = $objeto->ConsultarProducido();
                      ?>
                      ...
                      <tbody>
                        ...
                        while ($fila = mysqli_fetch_object($listado)) {
                          $codigo=$fila->produ_id;
                          $cantidad=$fila->produ_cantidad_producida;
                          $producto=$fila->pro_descripcion; ?>
                          <tr>
                            <td><?php echo $codigo; ?></td>
                            <td><?php echo $cantidad; ?></td>
                            <td><?php echo $producto;?></td>
                            <td><a href="ModificarProducido.php?id=<?php echo $codigo;?>" title="Modificar" class="btn btn-warning" type="button"><i class="fa fa-edit"></i></a>
                              <a onclick="return Eliminar()" style="display: <?php echo $Ocultar; ?>;" title="Eliminar" href="EliminarProducido.php?id=<?php echo $codigo;?>" class="btn btn-danger" type="button"><i class="fa fa-trash"></i></a></td>
                              <?php
                            }
                            ?>
                            </tbody>
    ...
    <script type="text/javascript" src="datatable/main.js"></script>  
        ...
        function Eliminar() {
          var respuesta = confirm("¿Estas seguro que desea eliminar este producido?");
