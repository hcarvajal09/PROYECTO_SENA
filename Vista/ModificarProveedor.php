              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  if (isset($_POST) && !empty($_POST)) {
                    ...
                    $resultado = $objeto->ModificarProvedor();
                    ...
                    if ($resultado == "correcto") {
                      ...
                      $mensaje = "El proveedor no fue modificado. " .$resultado;
                      ?>
                  ...
                  $datos = $objeto->ConsultarDatosProveedor($codigo);
                  ...
                  <form method="post" onsubmit="return validar();">
                   ...
                   <div class="row justify-content-center">
                    <div class="col-5">
                      <label for="nombre" class="formulario__label">Codigo</label>
                      <input class="formulario__input form-control" type="text" placeholder="Digite el nombre"  name="codigo" id="codigo" readonly="true" value="<?php echo $datos->prov_id; ?>" onkeyup="javascript:this.value=this.value.toUpperCase();">
                    </div>

                    <!-- Grupo: Nombre -->
                    <div class="col-5">
                      <label for="nombre">Nombre</label>
                      <input class="formulario__input form-control" type="text" placeholder="Digite el nombre"  name="nombres" id="nombres" value="<?php echo $datos->prov_nombres; ?>" onkeyup="javascript:this.value=this.value.toUpperCase();">
                    </div>
                  </div><br>
                  ...
                  <div class="row justify-content-center">
                    <div class="col-5">
                      ...
                      <input class="formulario__input form-control" type="text" placeholder="Digite el apellido" name="apellidos" id="apellidos" value="<?php echo $datos->prov_apellidos; ?>" onkeyup="javascript:this.value=this.value.toUpperCase();">
                    </div>

                    <!-- Grupo: Documento -->
                    <div class="col-5" id="grupo__documento">
                      <label for="documento" >Documento</label>
                      <input class="formulario__input form-control" type="text" placeholder="Digite el documento"  name="documento" id="documento" value="<?php echo $datos->prov_documento; ?>" onkeyup="javascript:this.value=this.value.toUpperCase();">
                    </div>
                  </div><br>
                  ...
                  <div class="row justify-content-center">
                    <div class="col-5">
                      ...
                      <input class="formulario__input form-control" type="text" placeholder="Digite el teléfono" name="telefono" id="telefono" value="<?php echo $datos->prov_telefono; ?>" onkeyup="javascript:this.value=this.value.toUpperCase();">
                    </div>
                ...
                <div class="row justify-content-center">
                  <a type="button" href="ConsultarProveedores.php" class="btn btn-outline-secondary mx-2">Cancelar</a>
...
<!-- OPTIONAL SCRIPTS -->
<script src="dist/js/validacion-proveedor.js"></script>
