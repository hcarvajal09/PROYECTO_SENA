							...
							<div class="card">
								...
								<div class="card-body">
									...
									if (isset($_POST) && !empty($_POST)) {
										...
										$resultado = $objeto->ModificarProducto();

										if ($resultado == "correcto") {
											echo"";

										  } else {
											$mensaje = "El producto no fue modificado. " .$resultado;
											?>
									...
									$datos = $objeto->ConsultarCodigoProducto($codigo);
									...
									<form method="post" onsubmit="return validar();">
										...
										<div class="row justify-content-center">
											<div class="col-5">
												...
												<input class="formulario__input form-control" type="text" readonly="true" placeholder="Digite el codigo" name="codigo" id="codigo" value="<?php echo $datos->pro_id; ?>" required onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>

											<div class="col-5">
												<label for="nombre">Nombre</label>
												<input class="formulario__input form-control" type="text" placeholder="Digite el nombre" name="nombre" id="nombre" value="<?php echo $datos->pro_nombre; ?>" required onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
										</div>
										<br/>
										...
										<div class="row justify-content-center">
											<div class="col-5">
												...
												<input class="formulario__input form-control" type="text" placeholder="Digite el precio" name="precio" id="precio"  value="<?php echo $datos->pro_precio; ?>" required>
											</div>

											<div class="col-5">
												<label for="descripcion">Descripción</label>
												<input class="formulario__input form-control" type="text" placeholder="Escriba la descripción del producto..." name="descripcion" id="descripcion"  value="<?php echo $datos->pro_descripcion; ?>"onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
										</div>
										<br />
										...
										<div class="row justify-content-center">
											<div class="col-5">
												...
												<input class="formulario__input form-control" type="text" placeholder="Digite la cantidad existente" required name="cantidad_e" id="cantidada_e"value="<?php echo $datos->pro_cantidad_existente; ?>">
											</div>
									...
									<div class="row justify-content-center">
										<a type="button" href="ConsultarProductos.php" class="btn btn-outline-secondary mx-2">Cancelar</a>
